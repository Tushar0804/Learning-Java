...
//		}
    ...
    void saveOutputIntoAFile() throws IOException
    {
        ...
        try
        {
            myObj = new FileWriter("/Users/tusharsharma/B Tech/4th Semester/Learning Java/src/Unit_03/Output.txt");
        } catch (IOException e)
        {
    ...
    void saveLogOfProgram() throws IOException
    {
        ...
        try
        {
            myObj = new FileWriter("/Users/tusharsharma/B Tech/4th Semester/Learning Java/src/Unit_03/log.txt",true);
        } catch (IOException e)
        {
            // TODO Auto-generated catch block
            e.printStackTrace();
